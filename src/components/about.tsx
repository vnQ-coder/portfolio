      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            A passionate Senior MERN Stack Developer with expertise in building
            scalable, full-stack web applications and delivering exceptional
            user experiences.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-slide-in-left">
            <h3 className="text-2xl font-bold text-white mb-6 gradient-text-secondary">
              My Journey
            </h3>
            <div className="space-y-6 text-gray-300">
              <p className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
                With over 5 years of experience in full-stack development, I
                have dedicated my career to mastering the MERN stack and
                delivering robust, scalable web applications. My journey began
                with a passion for JavaScript and quickly evolved into expertise
                across the entire development stack.
              </p>
              <p className="animate-fade-in" style={{ animationDelay: "0.4s" }}>
                I specialize in building end-to-end solutions using MongoDB for
                data management, Express.js for server-side logic, React for
                dynamic user interfaces, and Node.js for scalable backend
                services. My experience spans from startup MVPs to
                enterprise-level applications, always focusing on performance,
                security, and maintainability.
              </p>
              <p className="animate-fade-in" style={{ animationDelay: "0.6s" }}>
                My approach emphasizes clean code architecture, modern
                development practices, and continuous learning. I&apos;m
                passionate about staying current with the latest technologies
                and mentoring other developers to help them grow in their
                careers.
              </p>
            </div>
        ...
        <div className="mt-20 animate-fade-in" style={{ animationDelay: "1s" }}>
          <h3 className="text-2xl font-bold text-white text-center mb-12 gradient-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-300">
                Writing maintainable, readable, and well-documented code that
            ...
            >
              <div
                className="w-16 h-16 glass-dark rounded-full flex items-center justify-center mx-auto mb-4 animate-float hover-glow"
            ...
            >
              ...
              <p className="text-gray-300">
                Implementing robust security measures and following OWASP
                guidelines to protect applications and user data.
              </p>
            </div>
          </div>
        </div>
