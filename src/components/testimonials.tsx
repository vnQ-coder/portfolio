  ...
  const testimonials = [
    {
      ...
      content:
        "Working with Rohail Butt was exceptional. The MERN stack application he built for us is robust, scalable, and performs flawlessly. His technical expertise and clean code practices are outstanding.",
      rating: 5,
    ...
    },
    {
      ...
      image: "/api/placeholder/80/80",
      content:
        "The e-learning platform he developed using MERN stack has transformed our business. The MongoDB integration and React frontend are perfectly optimized. Highly recommend his services.",
      rating: 5,
    ...
    },
    {
      ...
      image: "/api/placeholder/80/80",
      content:
        "His social media dashboard built with Express.js and React is exactly what we needed. The real-time features and clean architecture make it a joy to work with. Excellent developer!",
      rating: 5,
    ...
    },
    {
      ...
      image: "/api/placeholder/80/80",
      content:
        "The restaurant ordering system he built with Node.js and MongoDB has streamlined our operations. The Socket.io integration for real-time updates is seamless. Great work!",
      rating: 5,
    ...
    },
    {
      ...
      image: "/api/placeholder/80/80",
      content:
        "The real estate portal he developed showcases excellent MERN stack skills. The MongoDB queries are optimized and the React components are well-structured. Highly professional.",
      rating: 5,
    ...
    },
    {
      ...
      image: "/api/placeholder/80/80",
      content:
        "His inventory management system built with full MERN stack is robust and reliable. The Mongoose schemas are well-designed and the API endpoints are perfectly documented.",
      rating: 5,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-slate-800 via-slate-900 to-slate-800">
        ...
        <div
          className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-float"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Here&apos;s what clients and colleagues say about my MERN stack
            development skills and professional approach.
          </p>
        </div>

        {/* Main Testimonial */}
        <div
          className="glass-dark rounded-xl p-8 mb-12 max-w-4xl mx-auto hover-lift animate-slide-up"
        ...
        {/* Stats */}
        <div
          className="mt-16 glass-dark rounded-xl p-8 text-white animate-fade-in"
        ...
        >
          ...
          <div className="relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              >
                <div className="text-3xl font-bold mb-2 gradient-text-secondary">
                  15+
                </div>
